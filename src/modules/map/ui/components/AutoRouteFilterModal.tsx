        ...
        <div className="flex gap-3 justify-between w-full">
          <div className="flex items-center gap-2">
            <label className="flex items-center gap-2 cursor-pointer group">
              <input 
                ...
                className="w-4 h-4 rounded bg-white/5 border-white/10 text-cyan-500 focus:ring-cyan-500 focus:ring-offset-slate-950"
              />
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-2 rounded-xl bg-amber-500 text-slate-950 font-bold hover:brightness-110 shadow-[0_0_15px_rgba(245,158,11,0.3)] transition active:scale-95 disabled:opacity-50 disabled:scale-100"
            >
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-2 gap-4 p-4 rounded-2xl bg-white/5 border border-white/10">
          <div className="space-y-2">
            <Label className="flex items-center gap-1.5 text-slate-300"><MapIcon size={14} className="text-cyan-400"/> Região</Label>
          ...
          <div className="space-y-2">
            <Label className="flex items-center gap-1.5 text-slate-300"><Compass size={14} className="text-cyan-400"/> Sub-Região</Label>
            <Select 
              value={subRegionId} 
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <Label className="text-sm font-bold text-slate-200">Categorias a Incluir</Label>
            <div className="flex items-center gap-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-48 h-8 pl-8 pr-3 rounded-lg bg-white/5 border border-white/10 text-xs text-white placeholder:text-slate-500 focus:outline-none focus:border-cyan-500/50 transition-colors"
                />
              </div>
              ...
              <button 
                ...
                className="text-[10px] font-bold uppercase tracking-wider text-cyan-400 hover:text-cyan-300 transition"
              >
                Todas
              </button>
              ...
              <button 
                ...
                className="text-[10px] font-bold uppercase tracking-wider text-slate-400 hover:text-slate-300 transition"
              >
                Nenhuma
              </button>
            </div>
            ...
            {availableCategories
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex items-center gap-2.5 p-2.5 rounded-xl border transition-all duration-200 text-left",
                    isSelected 
                      ? "border-cyan-500/40 bg-cyan-500/10 shadow-[0_0_10px_rgba(0,214,163,0.1)]"
